...
class AddAddressScreenDartBloc extends Bloc<AddAddressScreenDartEvent, AddAddressScreenDartState> {
  ...
  FutureOr<void> saveAddressClicked(SaveAddressClicked event, Emitter<AddAddressScreenDartState> emit) async {
   ...
   try{
    ...
    var response = await http.post(Uri.parse('$apiJsURL/add-address'), body: params);
